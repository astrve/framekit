...
Framekit encoder presets can be loaded by file name or by alias.
...
```bash
framekit encode --preset f265 input.mkv
framekit encode --preset serie264 input.mkv
framekit encode --preset anime265 input.mkv
framekit encode --preset films input.mkv
```
