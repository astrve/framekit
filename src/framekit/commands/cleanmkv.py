...
def run_cleanmkv_command(
    *,
    ...
    # Vérification si c'est un fichier, et si oui, si c'est un MKV
    if folder.is_file():
    ...
    # Si folder est un fichier, il a déjà été vérifié plus haut.
    # On vérifie ici si c'est un répertoire ou autre chose.
