...
from framekit.core.aliases import AliasError, AliasManager, InvalidAliasNameError
...
@click.group(
    name="alias",
    help="Manage command aliases for Framekit.",
)
...
def remove_alias(name: str, force: bool) -> None:
    ...
    try:
        ...
        if not force:
            from framekit.core.destructive import confirm_destructive
