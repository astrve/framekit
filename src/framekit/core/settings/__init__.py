...
This package was split out of the former ``framekit.core.settings`` module to
...
``from framekit.core.settings import X`` imports keep working unchanged.
"""
...
# "internal to framekit", not "private to this package", and these re-exports
