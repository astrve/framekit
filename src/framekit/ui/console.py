...
from framekit.ui.branding import framekit_theme
...
console = Console(theme=framekit_theme, legacy_windows=False)

# Export accent color for selector
from framekit.ui.branding import Colors  # noqa: E402

ACCENT = Colors.FRAMEKIT_ACCENT_PRIMARY
...
def print_success(message: str) -> None:
    ...
    if not _is_quiet_mode():
        from framekit.ui.branding import StatusIndicators
...
def print_exception_error(exc: BaseException, *, message: str | None = None) -> None:
    ...
    from framekit.ui.branding import Colors
...
def format_module_header(module_name: str) -> str:
    ...
    from framekit.ui.branding import get_module_color
...
def format_status_message(
    ...
    from framekit.ui.branding import format_status
...
def print_module_status(
    ...
    from framekit.ui.branding import format_status, get_module_color
