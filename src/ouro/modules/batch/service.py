...
from ouro.core.diagnostics import get_module_log_file
from ouro.core.i18n import tr
from ouro.core.parallel import get_optimal_worker_count
from ouro.core.performance import profile_time
from ouro.modules.batch.errors import BatchErrorType
...
from ouro.ui.console import print_error, print_info
...
class BatchService:
    ...
    def _validate_cleanmkv_preset(self, config: BatchConfig) -> list[str]:
        if not config.preset:
            return []
        from ouro.core.paths import get_cleanmkv_presets_dir, get_config_dir
