...
from ouro.modules.prez.template_categories import get_ordered_categories, get_template_category
from ouro.ui.console import console
from ouro.ui.unified_selector import SelectorInputAdapter
...
class ExpandCollapseSelector:
    ...
    def _handle_action(self, action: Any) -> str | None:
        ...
        from ouro.ui.unified_selector import SelectorAction
