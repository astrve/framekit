...
from ouro.core.settings import resolve_nfo_locale
from ouro.modules.nfo.formatting import (
...
from ouro.modules.nfo.template_registry import NfoTemplateRecord, NfoTemplateRegistry

PACKAGE_TEMPLATE_ROOT = "ouro.templates.nfo"
