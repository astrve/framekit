...
from ouro.core.verbose import configure_verbosity, is_verbose, log_file_processing
...
from ouro.ui.unified_selector import select_many as _select_many
...
@click.command(
    ...
    help=tr(
        ...
        default=(
            ...
            "Examples:\n"
            "  ouro screenshot video.mkv                    # Extract 6 screenshots\n"
            "  ouro screenshot video.mkv --count 10         # Extract 10 screenshots\n"
            "  ouro screenshot video.mkv --timestamps 120,240,360  # Specific times\n"
            "  ouro screenshot *.mkv --output ./screens     # Batch processing\n"
        ),
    ),
)
@click.argument(
...
from ouro.core.models.screenshot import ScreenshotReport, ScreenshotResult  # noqa: E402
