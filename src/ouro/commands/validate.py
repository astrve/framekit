...
def validate_command(
    ...
    \b
    Examples:
        ouro validate "Release folder"
        ouro validate "Release folder" --ruleset strict
        ouro validate "Release folder" --min-resolution 1920 --require-subs
        ouro validate "Release folder" --json
    """
    if strict:
