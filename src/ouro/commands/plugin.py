...
from ouro.ui.console import print_error, print_info, print_success
...
def _discover_installed_plugins() -> list[dict[str, object]]:
    try:
        from ouro.core.plugins import list_installed_plugins
...
def plugin_list_command() -> None:
    ...
    if not rows:
        print_info("No installed ouro.modules plugins discovered.")
        return
