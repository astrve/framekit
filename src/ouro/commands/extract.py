...
def extract_subtitle_command(
    ...
    Examples:
        ouro extract subtitle movie.mkv --format srt
        ouro extract subtitle *.mkv --language eng --output ./subs
        ouro extract subtitle movie.mkv --all
    """
...
def extract_audio_command(
    ...
    Examples:
        ouro extract audio movie.mkv --format aac
        ouro extract audio movie.mkv --format mp3 --bitrate 320k
        ouro extract audio movie.mkv --normalize
    """
...
def extract_video_command(
    ...
    Examples:
        ouro extract video movie.mkv --codec copy
        ouro extract video movie.mkv --codec h265 --crf 28
        ouro extract video movie.mkv --width 1920 --height 1080
    """
