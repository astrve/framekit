...
from ouro.commands.batch import batch_command
from ouro.commands.browse import browse_command
from ouro.commands.cleanmkv import cleanmkv_command
from ouro.commands.config import config_group
from ouro.commands.doctor import doctor_command
from ouro.commands.encoder import encode_group
from ouro.commands.examples import examples_command
from ouro.commands.extract import extract_command
from ouro.commands.init import init_command
from ouro.commands.inspect import inspect_command
from ouro.commands.language import language_command
from ouro.commands.logs import logs_command
from ouro.commands.metadata import metadata_command
from ouro.commands.nfo import nfo_command
from ouro.commands.pipeline import pipeline_command
from ouro.commands.prez import prez_command
from ouro.commands.profile import profile_group
from ouro.commands.renamer import renamer_command
from ouro.commands.rollback import rollback_command
from ouro.commands.screenshot import screenshot_command
from ouro.commands.serve import serve_command
from ouro.commands.service import service_group
from ouro.commands.seedbox import seedbox_group
from ouro.commands.settings import settings_command
from ouro.commands.setup import setup_command
from ouro.commands.sort import sort_command
from ouro.commands.tools import rename_parent_command
from ouro.commands.torrent import torrent_command
from ouro.commands.upload import upload_group
from ouro.commands.validate import validate_command
from ouro.commands.watch import watch_group
from ouro.core.aliases import AliasError, AliasManager
...
# ---------------------------------------------------------------------------
# rich_click command groups — organizes `ouro -h` into named sections
# ---------------------------------------------------------------------------
...
def _get_version() -> str:
    """Return the installed Ouro version."""
    for distribution_name in ("ouro-auto", "ouro"):
        try:
...
@click.command(
    "about",
    help=tr("cli.about.help", default="Show Ouro version, copyright and license information."),
)
def about_command() -> None:
    ...
    click.echo(
        ...
        "Repository: https://github.com/astrve/ouro\n"
...
@click.group(
    ...
    help=tr(
        "cli.main.help",
        default=(
            "Ouro — tracker-ready media workflow toolkit.\n\n"
...
# ---------------------------------------------------------------------------
# Third-party plugins (``ouro.modules`` entry-points)
# ---------------------------------------------------------------------------
def _load_third_party_plugins() -> None:
    import os

    if os.environ.get("OURO_DISABLE_PLUGINS", "").strip().lower() in {
        "1",
        "true",
        "yes",
        "on",
        ...
        return
    try:
        from ouro.core.plugins import load_plugins
