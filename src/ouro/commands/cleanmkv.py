...
from ouro.core.paths import PathResolver, get_presets_dir
from ouro.core.settings import SettingsStore
from ouro.core.tools import ToolRegistry
from ouro.core.verbose import configure_verbosity, is_verbose
from ouro.modules.cleanmkv.planner import get_builtin_preset
...
from ouro.modules.cleanmkv.scanner import scan_folder, scan_mkv_file
from ouro.modules.cleanmkv.service import CleanMkvService
from ouro.modules.cleanmkv.wizard import run_cleanmkv_track_selector, run_cleanmkv_wizard
...
from ouro.ui.unified_selector import confirm_choice, text_input
...
def _print_cleanmkv_diff(
    ...
    if not show_diff or not scans:
        return
    from ouro.modules.cleanmkv.diff import print_diff_for_plans
...
@click.command(
    ...
    help=tr(
        ...
        default=(
            ...
            "Quick examples:\n"
            "  ouro cleanmkv <folder>                    # Interactive track selector\n"
            "  ouro cmk <folder> --apply                 # Apply without preview confirmation\n"
            "  ouro cleanmkv <folder> --preset default   # Use builtin preset\n"
            "  ouro cmk <folder> --wizard                # Create custom preset\n"
            "  ouro cleanmkv <file.mkv>                  # Process single file\n\n"
            "Features:\n"
