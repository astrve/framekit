...
from ouro.core.paths import get_cache_dir, get_config_dir
from ouro.core.settings import SettingsStore, redact_settings, validate_settings
...
@click.group(name="config", help="Explain and validate Ouro configuration.")
def config_group() -> None:
    """Ouro config commands."""
