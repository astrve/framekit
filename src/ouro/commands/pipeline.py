...
from ouro.commands.pipeline_batch import run_batch_pipeline
from ouro.commands.pipeline_orchestrator import execute_pipeline_modules
from ouro.commands.pipeline_presets import (
...
from ouro.commands.pipeline_preview import (
    _gather_preview_data,
    _print_pipeline_preview,
    _print_pipeline_preview_comparison,
)
from ouro.commands.pipeline_steps import (
    _cleanmkv_step,
    _encoder_step,
...
# every name below is importable from ``ouro.commands.pipeline``; do not
...
# BatchQueueItem moved to ouro.modules.batch.models
...
def _pipeline_has_tmdb_token(settings: dict, store: SettingsStore) -> bool:
    if os.environ.get("OURO_TMDB_READ_ACCESS_TOKEN", "").strip():
        return True
            ...
            entries=[
                ...
                SelectorOption(
                    ...
                    hint=tr(
                        ...
                        default="Désactiver ce rappel dans ouro.yaml.",
                    ),
                ),
            ],
            page_size=6,
...
def _save_wizard_preset(preset_name: str, preset_config: dict) -> int:
    ...
    try:
        ...
        from ouro.ui.console import print_exception_error
...
def _resolve_remove_terms(
    ...
    from ouro.commands.renamer import (
