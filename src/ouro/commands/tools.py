"""Miscellaneous utility commands (ouro tools ...)."""
...
from ouro.core.release_payload import (
    VIDEO_EXTENSIONS,
...
def rename_parent_command(
    ...
    Examples:
        ouro rename-parent /path/to/Release.2024
        ouro rename-parent --name "Movie.2024.2160p.BluRay.REMUX"
        ouro rename-parent /path/to/Release --dry-run
    """
