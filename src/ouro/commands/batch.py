...
from ouro.modules.batch.models import BatchConfig, BatchStatus
from ouro.modules.batch.scanner import count_video_files, detect_release_type
...
@click.command(
    ...
    help=tr(
        ...
        default=(
            ...
            "Examples:\n"
            "  ouro batch                                # Interactive queue builder\n"
            "  ouro batch <parent>                       # Scan parent then interactive UI\n"
            "  ouro batch <parent> --auto --pipeline-preset films\n"
            "  ouro batch --add-folder <parent>          # Build queue, exit\n"
            "  ouro batch --list                         # Show current queue\n"
            "  ouro batch --process                      # Process saved queue\n"
        ),
    ),
)
...
def batch_command(
    ...
    from ouro.commands.pipeline import PIPELINE_MODULES_DEFAULT
