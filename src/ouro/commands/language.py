...
from ouro.core.i18n import get_supported_locales, set_locale, tr
from ouro.core.settings import SettingsStore, normalize_ui_locale
...
from ouro.ui.console import console, print_error, print_success
...
@click.group(
    ...
    help=tr("cli.language.help", default="Show or change the Ouro interface language."),
)
@click.pass_context
...
@language_command.command(
    "set", help=tr("cli.language.set.help", default="Set the Ouro interface language.")
)
