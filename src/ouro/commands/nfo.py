...
from ouro.core.path_validation import PathValidationError, validate_directory_path
...
from ouro.modules.nfo.formatting import format_bytes_human, format_duration_ms_human
...
from ouro.modules.nfo.template_registry import NfoTemplateRegistry, scope_matches
...
from ouro.modules.nfo.templates import import_template_file
    ...
    *,
    ...
    if is_single_file:
        ...
        if resolved_mode in ("global", "both"):
            ...
            release = release_probe
            rendered = ""
            from ouro.core.reporting import OperationReport as _OperationReport
...
def run_nfo_command(
    *,
    ...
    if not logo_path:
        from ouro.core.paths import get_bundled_nfo_logos_dir

        _default_logo = get_bundled_nfo_logos_dir() / "ouro.txt"
...
@click.command(
    ...
    help=tr(
        ...
        default=(
            ...
            "Quick examples:\n"
            "  ouro nfo <folder>                         # Interactive template selection\n"
            "  ouro nf <folder> -m                       # Include TMDb metadata\n"
            "  ouro nfo <folder> --write                 # Write immediately\n"
            "  ouro nf <file.mkv> -m -y                  # Single episode with auto-metadata\n"
            "  ouro nfo --list-templates                 # Show available templates\n\n"
            "Output modes:\n"
