...
from ouro.core.file_browser import BrowserConfig
from ouro.core.path_validation import validate_directory_path
from ouro.ui.click_helper import click
from ouro.ui.console import console, print_error, print_info
from ouro.ui.file_browser import FileBrowserTUI
...
def browse_command(
    ...
    Examples:
        ouro browse                          # Browse current directory
        ouro browse /path/to/dir             # Browse specific directory
        ouro browse --filter .mkv            # Filter by extension
        ouro browse --filter .mkv,.mp4       # Multiple extensions
        ouro browse --multi                  # Multi-select mode
        ouro browse --directories-only       # Show only directories
    """
