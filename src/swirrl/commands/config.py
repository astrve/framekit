...
from swirrl.core.paths import get_cache_dir, get_config_dir
from swirrl.core.settings import SettingsStore, redact_settings, validate_settings
...
@click.group(name="config", help="Explain and validate Swirrl configuration.")
def config_group() -> None:
    """Swirrl config commands."""
