...
from swirrl.core.aliases import AliasError, AliasManager, InvalidAliasNameError
...
@click.group(
    name="alias",
    help="Manage command aliases for Swirrl.",
)
...
def remove_alias(name: str, force: bool) -> None:
    ...
    try:
        ...
        if not force:
            from swirrl.core.destructive import confirm_destructive
