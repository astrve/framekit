...
from swirrl.core.i18n import get_supported_locales, set_locale, tr
from swirrl.core.settings import SettingsStore, normalize_ui_locale
...
from swirrl.ui.console import console, print_error, print_success
...
@click.group(
    ...
    help=tr("cli.language.help", default="Show or change the Swirrl interface language."),
)
@click.pass_context
...
@language_command.command(
    "set", help=tr("cli.language.set.help", default="Set the Swirrl interface language.")
)
