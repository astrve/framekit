...
from swirrl.core.release_inspection import inspect_release_completeness
...
from swirrl.ui.console import console, print_error
...
def inspect_command(path_parts: tuple[str, ...], json_output: bool) -> int:
    ...
    exit_code = run_inspect_command(join_path_parts(path_parts) or None, json_output=json_output)
    if exit_code != 0:
