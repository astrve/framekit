...
@click.command(
    ...
    help=tr(
        ...
        default=(
            ...
            "Examples:\n"
            "  swirrl screenshot video.mkv                    # Extract 6 screenshots\n"
            "  swirrl screenshot video.mkv --count 10         # Extract 10 screenshots\n"
            "  swirrl screenshot video.mkv --timestamps 120,240,360  # Specific times\n"
            "  swirrl screenshot *.mkv --output ./screens     # Batch processing\n"
        ),
    ),
)
@click.argument(
...
from swirrl.core.models.screenshot import ScreenshotReport, ScreenshotResult  # noqa: E402
