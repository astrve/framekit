...
from swirrl.modules.batch.models import BatchConfig, BatchStatus
from swirrl.modules.batch.scanner import count_video_files, detect_release_type
...
@click.command(
    ...
    help=tr(
        ...
        default=(
            ...
            "Examples:\n"
            "  swirrl batch                                # Interactive queue builder\n"
            "  swirrl batch <parent>                       # Scan parent then interactive UI\n"
            "  swirrl batch <parent> --auto --pipeline-preset films\n"
            "  swirrl batch --add-folder <parent>          # Build queue, exit\n"
            "  swirrl batch --list                         # Show current queue\n"
            "  swirrl batch --process                      # Process saved queue\n"
        ),
    ),
)
...
def batch_command(
    ...
    from swirrl.commands.pipeline import run_pipeline_command
    ...
    from swirrl.commands.pipeline import PIPELINE_MODULES_DEFAULT
