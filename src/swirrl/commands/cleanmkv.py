...
from swirrl.core.paths import PathResolver, get_presets_dir
from swirrl.core.settings import SettingsStore
from swirrl.core.tools import ToolRegistry
from swirrl.core.verbose import configure_verbosity, is_verbose
from swirrl.modules.cleanmkv.planner import get_builtin_preset
...
from swirrl.modules.cleanmkv.scanner import scan_folder, scan_mkv_file
from swirrl.modules.cleanmkv.service import CleanMkvService
from swirrl.modules.cleanmkv.wizard import run_cleanmkv_track_selector, run_cleanmkv_wizard
...
from swirrl.ui.unified_selector import confirm_choice, text_input
...
def _print_cleanmkv_diff(
    ...
    if not show_diff or not scans:
        return
    from swirrl.modules.cleanmkv.diff import print_diff_for_plans
...
@click.command(
    ...
    help=tr(
        ...
        default=(
            ...
            "Quick examples:\n"
            "  swirrl cleanmkv <folder>                    # Interactive track selector\n"
            "  swirrl cmk <folder> --apply                 # Apply without preview confirmation\n"
            "  swirrl cleanmkv <folder> --preset default   # Use builtin preset\n"
            "  swirrl cmk <folder> --wizard                # Create custom preset\n"
            "  swirrl cleanmkv <file.mkv>                  # Process single file\n\n"
            "Features:\n"
...
@click.option(
    ...
    "auto_mode",
    is_flag=True,
    help=tr("cli.cleanmkv.option.auto", default="Non-interactive mode — skip track selector and confirmation prompts."),
)
@click.option(
    "--verbose",
    "-v",
