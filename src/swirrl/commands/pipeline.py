...
from swirrl.commands.pipeline_batch import run_batch_pipeline
from swirrl.commands.pipeline_orchestrator import execute_pipeline_modules
from swirrl.commands.pipeline_presets import (
...
from swirrl.commands.pipeline_preview import (
...
# every name below is importable from ``swirrl.commands.pipeline``; do not
...
# BatchQueueItem moved to swirrl.modules.batch.models
...
def _pipeline_has_tmdb_token(settings: dict, store: SettingsStore) -> bool:
    if os.environ.get("SWIRRL_TMDB_READ_ACCESS_TOKEN", "").strip():
        return True
            ...
            entries=[
                ...
                SelectorOption(
                    ...
                    hint=tr(
                        ...
                        default="Désactiver ce rappel dans swirrl.yaml.",
                    ),
                ),
            ],
            page_size=6,
...
def _save_wizard_preset(preset_name: str, preset_config: dict) -> int:
    ...
    try:
        ...
        from swirrl.ui.console import print_exception_error
...
def _resolve_remove_terms(
    ...
    from swirrl.commands.renamer import (
