...
from swirrl.core.diagnostics import log_exception
...
from swirrl.modules.prez.template_selector import select_template_collapsible
...
@click.command(
    ...
    help=tr(
        ...
        default=(
            ...
            "Quick examples:\n"
            "  swirrl prez <folder>                        # Interactive template selection\n"
            "  swirrl prez <folder> -m                     # Include TMDb metadata\n"
            "  swirrl prez <folder> --format html          # HTML only\n"
            "  swirrl prez <folder> --preset premium       # Use preset\n"
            "  swirrl prez --list-templates                # Show available templates\n\n"
            "Template categories:\n"
