...
from swirrl.core.file_browser import BrowserConfig
from swirrl.core.path_validation import validate_directory_path
from swirrl.ui.click_helper import click
from swirrl.ui.console import console, print_error, print_info
from swirrl.ui.file_browser import FileBrowserTUI
...
def browse_command(
    ...
    Examples:
        swirrl browse                          # Browse current directory
        swirrl browse /path/to/dir             # Browse specific directory
        swirrl browse --filter .mkv            # Filter by extension
        swirrl browse --filter .mkv,.mp4       # Multiple extensions
        swirrl browse --multi                  # Multi-select mode
        swirrl browse --directories-only       # Show only directories
    """
