"""Miscellaneous utility commands (swirrl tools ...)."""
...
from swirrl.core.release_payload import (
    VIDEO_EXTENSIONS,
...
def rename_parent_command(
    ...
    Examples:
        swirrl rename-parent /path/to/Release.2024
        swirrl rename-parent --name "Movie.2024.2160p.BluRay.REMUX"
        swirrl rename-parent /path/to/Release --dry-run
    """
