...
from swirrl.core.verbose import configure_verbosity, is_verbose, log_file_processing
...
def extract_subtitle_command(
    ...
    Examples:
        swirrl extract subtitle movie.mkv --format srt
        swirrl extract subtitle *.mkv --language eng --output ./subs
        swirrl extract subtitle movie.mkv --all
    """
...
def extract_audio_command(
    ...
    Examples:
        swirrl extract audio movie.mkv --format aac
        swirrl extract audio movie.mkv --format mp3 --bitrate 320k
        swirrl extract audio movie.mkv --normalize
    """
...
def extract_video_command(
    ...
    Examples:
        swirrl extract video movie.mkv --codec copy
        swirrl extract video movie.mkv --codec h265 --crf 28
        swirrl extract video movie.mkv --width 1920 --height 1080
    """
