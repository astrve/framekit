...
This package was split out of the former ``swirrl.core.settings`` module to
...
``from swirrl.core.settings import X`` imports keep working unchanged.
"""
...
# "internal to swirrl", not "private to this package", and these re-exports
