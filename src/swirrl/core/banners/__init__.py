"""Banner Registry for the Swirrl presentation system.
...
class BannerConfig:
    ...
    def url(self) -> str:
        ...
        base_url = "https://github.com/astrve/swirrl/releases/download/banners-v1.0.0"
        # GitHub serves files from ZIP archives directly
        return f"{base_url}/swirrl-banners-v1.0.0.zip#{self.path}"
...
class BannerRegistry:
    ...
    ARCHIVE_URL = "https://github.com/astrve/swirrl/releases/download/banners-v1.0.0/swirrl-banners-v1.0.0.zip"
        ...
        for section in BannerSection:
            ...
            if banner:
                ...
                banners[section.value] = (
                    f"https://raw.githubusercontent.com/astrve/swirrl/refs/heads/feature/banners/{design}/{language}/{section.value}.png"
                )
