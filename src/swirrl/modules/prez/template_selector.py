...
from swirrl.modules.prez.template_categories import get_ordered_categories, get_template_category
from swirrl.ui.console import console
from swirrl.ui.unified_selector import SelectorInputAdapter
...
class ExpandCollapseSelector:
    ...
    def _handle_action(self, action: Any) -> str | None:
        ...
        from swirrl.ui.unified_selector import SelectorAction
