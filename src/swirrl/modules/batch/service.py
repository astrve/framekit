...
from swirrl.core.diagnostics import get_module_log_file
from swirrl.core.i18n import tr
from swirrl.core.parallel import get_optimal_worker_count
from swirrl.core.performance import profile_time
from swirrl.modules.batch.errors import BatchErrorType
...
from swirrl.ui.console import print_error, print_info
...
class BatchService:
    ...
    def _validate_cleanmkv_preset(self, config: BatchConfig) -> list[str]:
        if not config.preset:
            return []
        from swirrl.core.paths import get_cleanmkv_presets_dir, get_config_dir
