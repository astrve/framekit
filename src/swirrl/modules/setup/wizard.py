...
from swirrl.modules.setup.profiles import (
    get_profile,
    should_ask_question,
)
from swirrl.modules.setup.selector import ChoiceOption, choose_option
from swirrl.ui.unified_selector import SelectorOption, select_many
from swirrl.modules.setup.ui import (
    confirm_action,
    prompt_input,
...
from swirrl.modules.setup.validators import (
...
class SetupWizard:
    """Interactive setup wizard for Swirrl configuration."""
    ...
    def step_welcome(self) -> None:
        ...
        console.print(
            tr(
                ...
                default="This wizard will guide you through the initial setup of Swirrl.\n"
        ...
        if self.profile_config.show_help:
            show_help_text(
                tr(
                    ...
                    default="Choose the interface language for Swirrl. "
        ...
        if torrent_client == "qbittorrent":
            ...
            self._set_nested_value(
                ...
                prompt_input(
                    ...
                    default=str(self._get_nested_value("upload.torrent_client_category", "swirrl")),
                ).strip()
                or "swirrl",
            )
    ...
    def step_summary(self) -> dict[str, Any] | None:
        ...
        show_success_message(
            tr(
                ...
                default="Setup complete! Configuration saved to swirrl.yaml",
            )
        )

    def _save_configuration(self) -> None:
        """Save configuration to swirrl.yaml."""
        store = SettingsStore()
