...
from swirrl.core.audit_log import append_audit_event
...
from swirrl.modules.renamer.planner import build_rename_plan
from swirrl.modules.renamer.profiles import LanguageTagProfile, RenamerProfile
...
class RenamerService:
    ...
    def _apply_case_only_rename(self, source: Path, target: Path) -> None:
        temp_name = f".__swirrl_tmp__{uuid.uuid4().hex}{source.suffix}"
