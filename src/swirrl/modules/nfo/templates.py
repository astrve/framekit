...
from swirrl.modules.nfo.formatting import (
...
from swirrl.modules.nfo.template_registry import NfoTemplateRecord, NfoTemplateRegistry

PACKAGE_TEMPLATE_ROOT = "swirrl.templates.nfo"
