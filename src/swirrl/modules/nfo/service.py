...
from swirrl.core.paths import get_nfo_templates_dir
...
def _load_logo_text(logo_path: str | None) -> str | None:
    ...
    # Security: warn if logo is outside the swirrl templates directory
    ...
    try:
        ...
        logger.warning(
            "Logo file is outside the swirrl templates directory ({}): {}",
            templates_dir,
            resolved,
        )
