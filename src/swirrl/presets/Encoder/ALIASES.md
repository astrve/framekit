...
Swirrl encoder presets can be loaded by file name or by alias.
...
```bash
swirrl encode --preset f265 input.mkv
swirrl encode --preset serie264 input.mkv
swirrl encode --preset anime265 input.mkv
swirrl encode --preset films input.mkv
```
