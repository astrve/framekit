...
export const DEDICATED_MODULE_CONFIGS: DedicatedModuleConfig[] = [
  ...
  { slug: "extract", moduleName: "extract", title: "Extract", description: "Subtitle and track extraction.", presets: [{ id: "subs", label: "Subtitle", args: "subtitle \"\"" }] },
  { slug: "sort", moduleName: "sort", title: "Sort", description: "File sorting and organization.", presets: [{ id: "run", label: "Run", args: "\"\" --dry-run" }], requiredFlags: ["--dry-run"] },
