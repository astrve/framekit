...
Ouro 2.0.0 is the first public v2 release: a CLI-first media release toolkit for repeatable local workflows.

## GitHub Release Text

Ouro 2.0.0 is now available.
...
- End-to-end `ouro pipeline` workflow
...
Ouro 2.0.0 is out: CLI-first media release automation with pipeline, batch, MKV cleanup, metadata, NFO/Prez, torrents, validation, encrypted secrets, and standalone GitHub binaries.
