...
from swirrl.modules.screenshot.extractor import ScreenshotExtractor  # noqa: E402
...
class TestScreenshotExtractor:
    ...
    def test_extract_screenshot_success(self, extractor, tmp_path):
        ...
        with patch(
            "swirrl.modules.screenshot.extractor.run_safe", return_value=mock_result
        ) as mock_run:
    ...
    def test_extract_screenshot_ffmpeg_error(self, extractor, tmp_path):
        ...
        with patch("swirrl.modules.screenshot.extractor.run_safe", return_value=mock_result):
            result = extractor.extract_screenshot(
                video_path=video_path,
                output_path=output_path,
                timestamp=30.5,
    ...
    def test_extract_screenshot_timeout(self, extractor, tmp_path):
        ...
        with patch(
            "swirrl.modules.screenshot.extractor.run_safe",
    ...
    def test_extract_multiple_partial_failure(self, extractor, tmp_path):
        ...
        with patch("swirrl.modules.screenshot.extractor.run_safe", side_effect=mock_results):
...
class TestCommandSecurity:
    ...
    def test_timeout_is_enforced(self, extractor, tmp_path):
        ...
        with patch("swirrl.modules.screenshot.extractor.run_safe") as mock_run:
            extractor.extract_screenshot(
                video_path=video_path,
                output_path=output_path,
                timestamp=30.5,
