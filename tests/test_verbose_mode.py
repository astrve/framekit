...
from swirrl.core.verbose import (
    VerbosityLevel,
    configure_verbosity,
    get_verbosity_level,
    is_verbose,
...
class TestVerbosityIntegration:
    ...
    def test_verbosity_context_manager(self):
        ...
        from swirrl.core.verbose import verbosity_context
...
class TestVerbosityHelpers:
    ...
    def test_should_show_progress(self):
        ...
        from swirrl.core.verbose import should_show_progress
    ...
    def test_should_show_commands(self):
        ...
        from swirrl.core.verbose import should_show_commands
    ...
    def test_should_show_subprocess_output(self):
        ...
        from swirrl.core.verbose import should_show_subprocess_output
    ...
    def test_get_log_level_string(self):
        ...
        from swirrl.core.verbose import get_log_level_string
...
class TestVerbosityLoggingHelpers:
    ...
    def test_log_command_at_debug_level(self):
        ...
        from swirrl.core.verbose import log_command
    ...
    def test_log_subprocess_output_at_trace(self):
        ...
        from swirrl.core.verbose import log_subprocess_output
    ...
    def test_log_file_processing_at_verbose(self):
        ...
        from swirrl.core.verbose import log_file_processing
...
class TestBackwardCompatibility:
    ...
    def test_existing_progress_bars_work(self):
        ...
        with swirrl_progress("Test", total=10) as advance:
            advance(1)
            advance(1)
    ...
    def test_no_import_side_effects(self):
        ...
        import swirrl.core.verbose

        level_before = get_verbosity_level()
        importlib.reload(swirrl.core.verbose)
