...
class TestPrezSubtitleDedup:
    ...
    def test_subtitle_table_has_variant_column(self):
        ...
        from swirrl.modules.prez.models import PrezTrack
        from swirrl.modules.prez.service import _render_subtitle_tracks_bbcode
...
class TestUploadRateLimiter:
    ...
    def test_token_bucket_acquire(self):
        ...
        from swirrl.modules.upload.rate_limiter import _TokenBucket
    ...
    def test_registry_creates_per_tracker_limiter(self):
        ...
        from swirrl.modules.upload.models import TrackerConfig
        from swirrl.modules.upload.rate_limiter import TrackerRateLimiterRegistry
...
class TestUnifiedSelector:
    ...
    def test_selection_item_creation(self):
        ...
        from swirrl.ui.unified_selector import SelectionItem
    ...
    def test_selection_result_properties(self):
        ...
        from swirrl.ui.unified_selector import SelectionResult
    ...
    def test_headless_fallback_preselected(self):
        ...
        from swirrl.ui.unified_selector import SelectionItem, UnifiedSelector
    ...
    def test_build_entries_with_groups(self):
        ...
        from swirrl.ui.unified_selector import SelectionItem, SelectorDivider, UnifiedSelector
    ...
    def test_empty_items_returns_cancelled(self):
        ...
        from swirrl.ui.unified_selector import UnifiedSelector
