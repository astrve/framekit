...
from framekit.core.reporting import OperationReport  # noqa: E402
...
class TestExtractCLI:
    ...
    def test_extract_subtitle_single_file(self, runner, mock_service, tmp_path):
        ...
        from framekit.commands.extract import extract_subtitle_command

        # Create test file
        test_file = tmp_path / "test.mkv"
        test_file.touch()

        with patch("framekit.commands.extract.ExtractionService", return_value=mock_service):
    ...
    def test_extract_audio_single_file(self, runner, mock_service, tmp_path):
        ...
        from framekit.commands.extract import extract_audio_command
    ...
    def test_extract_video_single_file(self, runner, mock_service, tmp_path):
        ...
        from framekit.commands.extract import extract_video_command
