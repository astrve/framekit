...
from swirrl.modules.screenshot.service import ScreenshotService  # noqa: E402
...
class TestScreenshotService:
    ...
    def test_initialization_without_dependencies(self, mock_registry):
        ...
        with (
            patch("swirrl.modules.screenshot.service.FrameAnalyzer") as mock_analyzer_cls,
            patch("swirrl.modules.screenshot.service.ScreenshotExtractor") as mock_extractor_cls,
        ):
