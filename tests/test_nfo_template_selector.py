...
def test_template_selector_run_returns_selected(monkeypatch):
    ...
    monkeypatch.setattr("swirrl.modules.nfo.template_selector.select_one", fake_select_one)
...
def test_choose_template_scope(monkeypatch):
    ...
    monkeypatch.setattr("swirrl.modules.nfo.template_selector.TemplateSelector.run", fake_run)
