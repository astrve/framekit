...
class TestExtractionService:
    ...
    def mock_probe_media_file(self, monkeypatch: pytest.MonkeyPatch) -> None:
        ...
        monkeypatch.setattr(
            "swirrl.modules.extract.service.probe_media_file", lambda _: fake_info
        )
    ...
    def test_extract_subtitles_single_file(self, mock_registry, mock_subtitle_extractor, tmp_path):
        ...
        # Mock the extractor
        with patch(
            "swirrl.modules.extract.service.SubtitleExtractor",
    ...
    def test_extract_audio_single_file(self, mock_registry, mock_audio_extractor, tmp_path):
        ...
        from swirrl.modules.extract.models import AudioExtractionOptions
        from swirrl.modules.extract.service import ExtractionService
        ...
        with patch(
            "swirrl.modules.extract.service.AudioExtractor",
    ...
    def test_extract_video_single_file(self, mock_registry, mock_video_extractor, tmp_path):
        ...
        from swirrl.modules.extract.models import VideoExtractionOptions
        from swirrl.modules.extract.service import ExtractionService
        ...
        with patch(
            "swirrl.modules.extract.service.VideoExtractor",
    ...
    def test_extract_audio_uses_lang_role_index_naming(
        ...
        monkeypatch.setattr("swirrl.modules.extract.service.probe_media_file", lambda _: fake_info)
        mock_audio_extractor.detect_audio_format.return_value = AudioFormat.AAC
    ...
    def test_extract_subtitles_uses_lang_role_naming(
        ...
        from swirrl.modules.extract.models import ExtractionOptions
        from swirrl.modules.extract.service import ExtractionService
