...
from swirrl.modules.renamer.detector import hdr_display_label, hdr_release_label
from swirrl.modules.renamer.profiles import load_renamer_profile
...
def test_remove_terms_from_stem_removes_tokens_and_cleans_separators():
    ...
    from swirrl.modules.renamer.planner import _remove_terms_from_stem
...
def test_remove_terms_from_normalized_name_removes_reintroduced_tokens():
    ...
    from swirrl.modules.renamer.planner import _remove_terms_from_normalized_name
