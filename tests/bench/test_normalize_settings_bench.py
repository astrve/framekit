...
from framekit.core.settings.normalize import normalize_settings
from framekit.core.settings.schema import DEFAULT_SETTINGS
...
def test_bench_normalize_settings_overridden(benchmark) -> None:
    ...
    payload.setdefault("plugins", {})["allowed"] = ["framekit-plugin-anilist"]
    result = benchmark(normalize_settings, payload)
