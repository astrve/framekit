...
This directory contains the comprehensive test suite for Framekit, organized by test type and module.
...
pytest --cov=src/framekit --cov-report=html
...
pytest --cov=src/framekit --cov-report=json
```
...
def test_with_fixtures(isolated_env, mock_settings, tmp_path):
    ...
    assert "FRAMEKIT_CACHE_DIR" in isolated_env
...
def test_with_env_var(monkeypatch):
    ...
    monkeypatch.setenv("FRAMEKIT_DEBUG", "true")
